          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  Code the Future with span Two Nerds
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
                  ...
                  delay={0.5}
                  as="p"
                  className="mx-auto mt-8 max-w-2xl text-balance text-lg line-clamp-4"
                >
                  ...
                  AI-driven innovations, we help businesses harness the power of
                  technology to grow, adapt, and thrive in the digital era.
